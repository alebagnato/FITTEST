 ...
 * <ul>
 *   <li>{@link eu.fittest.test.project.TestProject#getGeneral <em>General</em>}</li>
 *   <li>{@link eu.fittest.test.project.TestProject#getLogging <em>Logging</em>}</li>
 *   <li>{@link eu.fittest.test.project.TestProject#getModelInference <em>Model Inference</em>}</li>
 *   <li>{@link eu.fittest.test.project.TestProject#getTestGeneration <em>Test Generation</em>}</li>
 *   <li>{@link eu.fittest.test.project.TestProject#getOracle <em>Oracle</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.fittest.test.project.ProjectPackage#getTestProject()
 * @model extendedMetaData="name='TestProject' kind='elementOnly'"
 * @generated
 */
public interface TestProject extends EObject {
	 ...
	 * @see eu.fittest.test.project.ProjectPackage#getTestProject_General()
	...
	/**
	 * Sets the value of the '{@link eu.fittest.test.project.TestProject#getGeneral <em>General</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.fittest.test.project.ProjectPackage#getTestProject_Logging()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link eu.fittest.test.project.TestProject#getLogging <em>Logging</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.fittest.test.project.ProjectPackage#getTestProject_ModelInference()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link eu.fittest.test.project.TestProject#getModelInference <em>Model Inference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.fittest.test.project.ProjectPackage#getTestProject_TestGeneration()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link eu.fittest.test.project.TestProject#getTestGeneration <em>Test Generation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.fittest.test.project.ProjectPackage#getTestProject_Oracle()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link eu.fittest.test.project.TestProject#getOracle <em>Oracle</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
