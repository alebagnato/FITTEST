...
public class IncludedFunctions extends EMFPropertyStringComposite {

	public IncludedFunctions(OracleComposite parent, int style, FormToolkit toolkit,
	...
	protected EStructuralFeature getFeature() {
		return ProjectPackage.eINSTANCE.getOracleType_FunctionsToInclude();
	}

	@Override
	protected String getLabelText() {
		return "Functions to include: ";
	}
