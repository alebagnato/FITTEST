 ...
 * @generated
 */
public class TestGenerationTypeImpl extends MinimalEObjectImpl.Container implements TestGenerationType {
	/**
	 ...
	 * @ordered
	 */
	protected static final ModelVisitStrategyType MODEL_VISIT_STRATEGY_EDEFAULT = ModelVisitStrategyType.VISITORBREADTHFIRST;
	 ...
	 * @ordered
	 */
	protected static final BrowserType SELENIUM_DRIVER_BROWSER_EDEFAULT = BrowserType.HTML_UNIT_DRIVER;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ProjectPackage.TEST_GENERATION_TYPE__MODEL_VISIT_STRATEGY:
				...
				return;
			case ProjectPackage.TEST_GENERATION_TYPE__REDUCE_TEST_SUITE:
				setReduceTestSuite((Boolean)newValue);
				return;
			case ProjectPackage.TEST_GENERATION_TYPE__SOURCE_PACKAGE_PREFIX:
			...
			case ProjectPackage.TEST_GENERATION_TYPE__SELENIUM_REMOTE_HOST:
				...
				return;
			case ProjectPackage.TEST_GENERATION_TYPE__SELENIUM_REMOTE_PORT:
				setSeleniumRemotePort((Integer)newValue);
				return;
			case ProjectPackage.TEST_GENERATION_TYPE__SELENIUM_BROWSER_CONFIG:
