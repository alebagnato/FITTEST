 ...
 * @generated
 */
public class ModelInferenceTypeImpl extends MinimalEObjectImpl.Container implements ModelInferenceType {
	/**
	 ...
	 * @ordered
	 */
	protected static final InferenceTechniqueType INFERENCE_TECHNIQUE_EDEFAULT = InferenceTechniqueType.SEQUENCEBASED;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ProjectPackage.MODEL_INFERENCE_TYPE__INFERENCE_TECHNIQUE:
				...
				return;
			case ProjectPackage.MODEL_INFERENCE_TYPE__GENERATE_DOT:
				setGenerateDot((Boolean)newValue);
				return;
			case ProjectPackage.MODEL_INFERENCE_TYPE__GA_PARAM:
