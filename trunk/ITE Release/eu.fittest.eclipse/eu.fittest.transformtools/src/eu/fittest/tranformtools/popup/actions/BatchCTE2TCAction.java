...
public class BatchCTE2TCAction extends AbstractHandler implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (selectedFolders != null && selectedFolders.length > 0) {
			...
			TCBatchGenWizard batchWizard = new TCBatchGenWizard(shell, folder.getLocation().toOSString(),folder.getProject());
