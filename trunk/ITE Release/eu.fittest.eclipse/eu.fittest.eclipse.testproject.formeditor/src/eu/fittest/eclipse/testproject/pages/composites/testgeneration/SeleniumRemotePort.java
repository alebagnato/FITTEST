...
public class SeleniumRemotePort extends EMFPropertyStringComposite {

	public SeleniumRemotePort(Composite parent, int style, FormToolkit toolkit,
	...
	protected EStructuralFeature getFeature() {
		return ProjectPackage.eINSTANCE.getTestGenerationType_SeleniumRemotePort();
	}

	@Override
	protected String getLabelText() {
		return "Selenium remote port: ";
	}
