...
import eu.fittest.test.project.impl.TestProjectImpl;
...
//		toolkit.createCompositeSeparator(section);
		...
		EObject loggingModel = ((TestProjectImpl)rootModel).getLogging().getLogTarget();
...
//		Section instrumentSection = this.createSection(pageComposite, toolkit, "Instrumentation Settings", null);
		...
		EObject instrumentationModel = ((TestProjectImpl)rootModel).getLogging().getInstrumentation();
