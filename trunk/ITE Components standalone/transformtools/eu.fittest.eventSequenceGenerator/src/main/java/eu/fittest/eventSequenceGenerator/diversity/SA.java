...
import eu.fittest.eventSequenceGenerator.semanticInteraction.SEMsextractor;
...
public class SA {
	...
	SEMsextractor semSeqs=new SEMsextractor();
	...
	void initialzation(){
		//usare una stima?
		suite_sem=semSeqs.get_allSequences_K(true, originalFsmPath, k, TypeOfVisit.givenLengthK.toString());
	...
	do{
		...
		//System.out.println("2 - evolution (SuiteIt="+SuiteIt+")");
