...
public class FSM2CTEAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (selectedFile != null && selectedFile.length > 0) {
			...
			CTEGenWizard generationWizard = new CTEGenWizard(file.getLocation().toOSString());
