...
public class ComplexDataSpecType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "enumerationion", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.class),
        @XmlElementRef(name maxInclusiveion", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.class),
        @XmlElementRef(name maxExclusiveion", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.class),
        @XmlElementRef(name minInclusiveion", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.class),
        @XmlElementRef(name mentRef(name = "pattern", namespace = "http://www.fbk.eu/xinput", type = Pattern.class),
        @XmlElementRef(ame = "minExclusive", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.class),
        @XmlEleminLaxInclusive", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.class),
        ...
        @XmlElementRef(name minExclusiveion", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.class),
        @XmlElementRef(name maxLaxInclusive", namespace = "http://www.fbk.eu/xinput", type = JAXBElement.
    })
     ...
     * {@link JAXBElement }{@code <}{@lFacet }{@code > }
     * {@link JAXBElement }{@code <}{@link NumFacet }{@code >}
