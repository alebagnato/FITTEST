...
public class CTE2SelenAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (selectedFile != null && selectedFile.length > 0) {
			...
			SeleniumGenWizard wizard = new SeleniumGenWizard(file, file.getProject());
					...
					protected IStatus run(final IProgressMonitor monitor) {
						...
						try{
							if (selenDriver.equals(Constants.FLEX_OBJECT_DRIVER)){
									templateGroupFile = FileLocator.toFileURL(bundle.getEntry("templates/junit.flexdriver.stg")).getFile();
							} else if (selenDriver.equals(Constants.FLASH_OBJECT_DRIVER)){
								templateGroupFile = FileLocator.toFileURL(bundle.getEntry("templates/junit.flashdriver.stg")).getFile();
							} else {
								templateGroupFile = FileLocator.toFileURL(bundle.getEntry("templates/junit4.wdriver.stg")).getFile();
							}
