...
//		logPause = new ToolItem(logBar, SWT.CHECK);
//		logPause.setEnabled(false);
//		logPause.addSelectionListener(new SelectionAdapter() {
//			@Override
//			public void widgetSelected(SelectionEvent e) {
//				pauseLog();
//			}
//		});
//		logPause.setText("Pause");
//		
//		logStop = new ToolItem(logBar, SWT.NONE);
//		logStop.setEnabled(false);
//		logStop.addSelectionListener(new SelectionAdapter() {
//			@Override
//			public void widgetSelected(SelectionEvent e) {
//				stopLog();
//			}
//		});
//		logStop.setText("Stop");
...
//		tGenGen.setEnabled(false);
	...
	protected void showLogStatus() {
		MessageDialog.openInformation(logConfig.getShell(), "Information", "In final integration, you'd see the view with available clients now.");
	...
	protected void showLogResults() {
		MessageDialog.openInformation(logConfig.getShell(), "Information", "In final integration, you'd see the Logging Results now.");
...
//		logStop.setEnabled(true);
	...
	protected void showTExecResult() {
		MessageDialog.openInformation(logConfig.getShell(), "Information", "In final integration, you'd see the Test Execution Results now.");
...
//		tExecStop.setEnabled(true);
	...
	protected void showTGenResult() {
		MessageDialog.openInformation(logConfig.getShell(), "Information", "In final integration, you'd see the Test Generation Results now.");
