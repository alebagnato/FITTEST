 ...
 * <ul>
 *   <li>{@link eu.fittest.test.project.impl.TestProjectImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link eu.fittest.test.project.impl.TestProjectImpl#getLogging <em>Logging</em>}</li>
 *   <li>{@link eu.fittest.test.project.impl.TestProjectImpl#getModelInference <em>Model Inference</em>}</li>
 *   <li>{@link eu.fittest.test.project.impl.TestProjectImpl#getTestGeneration <em>Test Generation</em>}</li>
 *   <li>{@link eu.fittest.test.project.impl.TestProjectImpl#getOracle <em>Oracle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestProjectImpl extends MinimalEObjectImpl.Container implements TestProject {
	...
	protected EClass eStaticClass() {
		return ProjectPackage.Literals.TEST_PROJECT;
	}
	...
	public NotificationChain basicSetGeneral(GeneralType newGeneral, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__GENERAL, oldGeneral, newGeneral);
	...
	public void setGeneral(GeneralType newGeneral) {
		if (newGeneral != general) {
			...
			if (general != null)
				msgs = ((InternalEObject)general).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__GENERAL, null, msgs);
			if (newGeneral != null)
				msgs = ((InternalEObject)newGeneral).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__GENERAL, null, msgs);
			msgs = basicSetGeneral(newGeneral, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__GENERAL, newGeneral, newGeneral));
	}
	...
	public NotificationChain basicSetLogging(LoggingType newLogging, NotificationChain msgs) {
		...
		logging = newLogging;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__LOGGING, oldLogging, newLogging);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLogging(LoggingType newLogging) {
		if (newLogging != logging) {
			NotificationChain msgs = null;
			if (logging != null)
				msgs = ((InternalEObject)logging).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__LOGGING, null, msgs);
			if (newLogging != null)
				msgs = ((InternalEObject)newLogging).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__LOGGING, null, msgs);
			msgs = basicSetLogging(newLogging, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__LOGGING, newLogging, newLogging));
	}
	...
	public NotificationChain basicSetModelInference(ModelInferenceType newModelInference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__MODEL_INFERENCE, oldModelInference, newModelInference);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setModelInference(ModelInferenceType newModelInference) {
		if (newModelInference != modelInference) {
			...
			if (modelInference != null)
				msgs = ((InternalEObject)modelInference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__MODEL_INFERENCE, null, msgs);
			if (newModelInference != null)
				msgs = ((InternalEObject)newModelInference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__MODEL_INFERENCE, null, msgs);
			msgs = basicSetModelInference(newModelInference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__MODEL_INFERENCE, newModelInference, newModelInference));
	}
	...
	public NotificationChain basicSetTestGeneration(TestGenerationType newTestGeneration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__TEST_GENERATION, oldTestGeneration, newTestGeneration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTestGeneration(TestGenerationType newTestGeneration) {
		if (newTestGeneration != testGeneration) {
			...
			if (testGeneration != null)
				msgs = ((InternalEObject)testGeneration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__TEST_GENERATION, null, msgs);
			if (newTestGeneration != null)
				msgs = ((InternalEObject)newTestGeneration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__TEST_GENERATION, null, msgs);
			msgs = basicSetTestGeneration(newTestGeneration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__TEST_GENERATION, newTestGeneration, newTestGeneration));
	}
	...
	public NotificationChain basicSetOracle(OracleType newOracle, NotificationChain msgs) {
		...
		oracle = newOracle;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__ORACLE, oldOracle, newOracle);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOracle(OracleType newOracle) {
		if (newOracle != oracle) {
			NotificationChain msgs = null;
			if (oracle != null)
				msgs = ((InternalEObject)oracle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__ORACLE, null, msgs);
			if (newOracle != null)
				msgs = ((InternalEObject)newOracle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProjectPackage.TEST_PROJECT__ORACLE, null, msgs);
			msgs = basicSetOracle(newOracle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.TEST_PROJECT__ORACLE, newOracle, newOracle));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProjectPackage.TEST_PROJECT__GENERAL:
				return basicSetGeneral(null, msgs);
			case ProjectPackage.TEST_PROJECT__LOGGING:
				return basicSetLogging(null, msgs);
			case ProjectPackage.TEST_PROJECT__MODEL_INFERENCE:
				return basicSetModelInference(null, msgs);
			case ProjectPackage.TEST_PROJECT__TEST_GENERATION:
				return basicSetTestGeneration(null, msgs);
			case ProjectPackage.TEST_PROJECT__ORACLE:
