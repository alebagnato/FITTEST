...
import eu.fittest.eclipse.oraclesuite.wizards.InferlloWizard;

public class InferLLOAction extends AbstractHandler implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (selectedFolders != null && selectedFolders.length > 0) {
			...
			InferlloWizard inferlloWizard = new InferlloWizard(folder.getLocation().toOSString());
			WizardDialog dialog = new WizardDialog(shell, inferlloWizard);
			dialog.open();
