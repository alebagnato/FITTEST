...
import eu.fittest.eclipse.oraclesuite.wizards.ChecklloWizard;

public class CheckLLOAction extends AbstractHandler implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (selectedFolders != null && selectedFolders.length > 0) {
			...
			ChecklloWizard checklloWizard = new ChecklloWizard(folder.getLocation().toOSString());
			WizardDialog dialog = new WizardDialog(shell, checklloWizard);
			dialog.open();
