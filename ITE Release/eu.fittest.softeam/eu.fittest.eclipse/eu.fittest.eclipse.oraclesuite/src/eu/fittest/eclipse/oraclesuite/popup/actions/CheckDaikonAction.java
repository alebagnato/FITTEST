...
import eu.fittest.eclipse.oraclesuite.wizards.CheckDaikonWizard;

public class CheckDaikonAction extends AbstractHandler implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		if (selectedFolders != null && selectedFolders.length > 0) {
			...
			CheckDaikonWizard checkDaikonWizard = new CheckDaikonWizard(folder.getLocation().toOSString());
			WizardDialog dialog = new WizardDialog(shell, checkDaikonWizard);
			dialog.open();
