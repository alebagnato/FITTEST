...
public class ChecklloWizard extends Wizard {

	ChecklloPage inputPage = null;

	private String logFolder = "";

	public ChecklloWizard(String logFolder) {
		super();
	...
	public boolean performFinish() {
		if (this.inputPage != null){
			...
			Job generateJob = new Job("Checking low level"){

				protected IStatus run(final IProgressMonitor monitor) {	


					PerlScripts.checkllo(logFolder, _newlogFolder, _oracleFileName, _violationFileName, _reportFileName);
	...
	public void addPages() {
		...
		this.inputPage = new ChecklloPage("Check low level oracles");
		this.inputPage.setTitle("Checking low level oracles");
