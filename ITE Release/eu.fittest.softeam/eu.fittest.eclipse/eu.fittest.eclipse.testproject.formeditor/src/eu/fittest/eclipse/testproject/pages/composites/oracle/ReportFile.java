...
public class ReportFile extends EMFPropertyStringComposite {

	public ReportFile(OracleComposite parent, int style, FormToolkit toolkit,
	...
	protected EStructuralFeature getFeature() {
		return ProjectPackage.eINSTANCE.getOracleType_ReportFile();
	}
